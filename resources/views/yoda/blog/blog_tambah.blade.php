  ...
  <div class="hp-main-layout-content">
    <div class="row mb-32 g-32">
      <div class="col flex-grow-1 overflow-hidden">
        <div class="row g-32">
          <div class="col-12">
            <h1 class="hp-mb-0">Tambah Blog</h1>
          </div>
              ...
              <div class="card bg-white border-0 rounded-10 mb-4">
                <div class="card-body">
                  <div class="d-flex justify-content-between align-items-center border-bottom pb-20 mb-20">
                    <h4 class="fw-semibold fs-18 mb-0">Form Tambah Blog</h4>
                  ...
                  <div class="row">
                    <div class="col-md-12">
                      ...
                      <div class="position-relative">
                        <input type="text" class="form-control h-58 ps-5" id="validationCustom01" value=""
                          required name="judul_blog" placeholder="Masukkan judul Blog...">
                    ...
                    <div class="col-md-12">
                      <label for="validationCustom01" class="form-label label mb-0">Tanggal Blog <small
                          class="text-danger">*</small></label>
                      <div class="position-relative">
                        <input type="date" class="form-control h-58 ps-5" id="validationCustom01" value=""
                    ...
                    <div class="row">
                      <div class="col-md-6">
                        <div class="col-md-12 mt-3">
                          ...
                          <textarea name="deskripsi_singkat" class="form-control h-58 ps-5" required></textarea>
                        </div>
                        <div class="col-md-12 mt-3">
                          <label for="validationCustom01" class="form-label label mb-0">Isi Deskripsi Blog <small
                              class="text-danger">*</small></label>
                          <textarea name="deskripsi_blog" class="form-control h-58 ps-5"  style="width: 495px; height: 270px;"" required></textarea>
                        </div>
                      </div>
                      <div class="col-md-6">
